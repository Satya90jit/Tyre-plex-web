...
const CardHolder: FC<Props> = ({
  ...
  return (
    <div
      className={`shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-md ${CardHolderStyle.layout}`}
    >
      <div className={CardHolderStyle.container}>
        ...
        >
          ...
          <span
            style={{ display: "flex", gap: gap || "6px" }}
            id="two"
            ref={childWarper}
          >
            {children}
